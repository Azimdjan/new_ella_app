...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "magic_chat": MessageLookupByLibrary.simpleMessage("Волшебный чат"),
        ...
        "welcomeBackSubtitle": MessageLookupByLibrary.simpleMessage(
            "Все славные луны любят друг друга, только у великих солнц есть благодать"),
        "welcomeSubtitle": MessageLookupByLibrary.simpleMessage(
            "Все великолепные луны любят друг друга, только великие солнца обладают благодатью")
      };
}
